...
/**
 * 文件名：MybatisBaseUtil.java<p>
 * 创建时间：2025-07-11 17:11<p>
 * 功能描述：MybatisPlus 的 Util<p>
 * 创建人：蓝田_Loto
 */
public class MybatisBaseUtil {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                if (!ObjectUtils.isEmpty(obj)) {
                    String name = MybatisBaseUtil.humpToLine(field.getName());
    ...
    /**
     * 反射获取字段值：[entity, value] 值为 "id" "name" 等
     */
